...
class _AssignmentScreenState extends State<AssignmentScreen> {
  ...
  bool _showUploadAssignmentButton() {
    ...
    // Parse the due date using the assignment's date format from admin panel
    DateTime? dueDate = Utils.parseAssignmentDueDate(
        submittedAssignment.dueDate, submittedAssignment.dateFormat);
    if (dueDate == null) {
    ...
    //then hide upload submit button
    if (currentDayDateTime.compareTo(dueDate) == 1) {
      return false;
    }
    return true;
  }
