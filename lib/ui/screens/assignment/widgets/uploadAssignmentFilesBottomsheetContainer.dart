...
class _UploadAssignmentFilesBottomsheetContainerState
  ...
  Future<void> _addFiles() async {
    await _pickFiles(); // No permission check needed
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...List.generate(uploadedFiles.length, (index) => index)
                      .map(
                          (fileIndex) => _buildUploadedFileContainer(fileIndex))
                      .toList(),
                  ...
                  uploadedFiles.isNotEmpty
                      ? BlocConsumer<UploadAssignmentCubit,
                          ...
                          builder: (context, state) {
                            return CustomRoundedButton(
                              ...
                              height: 40,
                              widthPercentage:
                                  state is UploadAssignmentInProgress
                                      ? 0.8
                                      : 0.35,
                              backgroundColor:
                                  Theme.of(context).colorScheme.primary,
                              buttonTitle: state is UploadAssignmentInProgress
                                  ? "${Utils.getTranslatedLabel(submittingKey)}... (${state.uploadedProgress.toStringAsFixed(0)})%"
