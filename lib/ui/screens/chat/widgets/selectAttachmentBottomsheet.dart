...
class _SelectAttachmentBottomSheetState
  ...
  // FIXED – Now uses FilePicker (Android Photo Picker) – NO PERMISSIONS REQUIRED
  ...
  Future<void> _getFromCamera() async {
    ...
    if (!hasPermission) {
      Get.snackbar("Permission Denied", "Camera access not allowed");
      return;
    }
