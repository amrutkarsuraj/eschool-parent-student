...
class _TransactionsScreenState extends State<TransactionsScreen> {
  ...
  Widget _buildSafeDateTime(BuildContext context, String dateString) {
    try {
      DateTime parsedDate;

      // Try different date formats
      if (dateString.contains('PM') || dateString.contains('AM')) {
        // Handle format like "25-09-2025 10:45 PM"
        ...
        // Try different dash-separated formats
        try {
              ...
              if (state is PaymentTransactionsFetchSuccess) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (transaction.paymentStatus == succeedTransactionStatusKey) {
                      transactionStatusColor = Theme.of(context).colorScheme.onSecondary;
                    } else if (transaction.paymentStatus == failedTransactionStatusKey) {
                      transactionStatusColor = Theme.of(context).colorScheme.error;
                    }
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              const Spacer(),
                              // Only show date/time if createdAt exists and is not empty
                              (transaction.createdAt == null || transaction.createdAt!.isEmpty)
                                  ? const SizedBox()
                                  : _buildSafeDateTime(context, transaction.createdAt!),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              const Spacer(),
                              Text(
                                Utils.getTranslatedLabel(transaction.paymentStatus ?? ""),
                                style: TextStyle(
                                  fontSize: 12.0,
