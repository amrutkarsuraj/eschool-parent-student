...
class Assignment {
  ...
  late final String
      createdAt; //It will work as assigned date - raw string from API
  late List<StudyMaterial> referenceMaterials;
  late final String instructions;
  late final String dueDate;
  late final String dueDateRaw; //Raw date string from API
  late final String dateFormat; //Date format from admin panel
  ...
  Assignment.fromJson(Map<String, dynamic> json) {
    ...
    dueDateRaw = json['due_date'] ?? "";
    dateFormat =
        json['date_format'] ?? "Y-m-d"; // Default to Y-m-d if not provided
