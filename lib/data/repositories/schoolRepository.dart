...
class SchoolRepository {
  ...
  Future<List<SliderDetails>> fetchSliders(
    ...
    try {
      ...
      print("📡 Fetching sliders | useParentApi=$useParentApi | body=$body");
      print(
          "📡 Final URL: ${useParentApi ? Api.getParentSliders : Api.getStudentSliders}");
