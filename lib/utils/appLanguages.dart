...
const List<AppLanguage> appLanguages = [
  ...
  AppLanguage(languageCode: "mi", languageName: "मराठी - Marathi"),
  AppLanguage(languageCode: "kn", languageName: "ಕನ್ನಡ - Kannada"),
  AppLanguage(languageCode: "ta", languageName: "தமிழ் - Tamil"),
  AppLanguage(languageCode: "bho", languageName: "भोजपुरी - Bhojpuri"),
  AppLanguage(languageCode: "mai", languageName: "मैथिली - Maithili"),
  //
